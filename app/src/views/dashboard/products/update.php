        ...
        <section class="grow h-full">
            ...
            <section class="px-6 py-8">
                <div class="shadow-md rounded-md p-5">
                    ...
                    <div class="mt-6">
                        <form action="/dashboard/products/update/<?= $product['id_product'] ?>" method="post" enctype="multipart/form-data">
                            <div class="mb-3 flex flex-col">
                                <label for="product-name" class="text-xl font-semibold">Product Name</label>
                                <input type="text" name="product-name" value="<?= $product['product_name'] ?>" class="border-2 p-2 rounded-md focus:outline-offset-2 focus:outline-2 focus:outline-blue-500" placeholder="Enter Product Name">
                            </div>
                            <div class="mb-3 flex flex-col">
                                ...
                                <select name="product-category" class="border-2 p-2 rounded-md focus:outline-offset-2 focus:outline-2 focus:outline-blue-500" id="product-category">
                                    ...
                                    <?php foreach($categorys as $category) : ?>
                                        <option value="<?= $category['id_category'] ?>" <?= $category['id_category'] === $product['product_category'] ? 'selected' : ''; ?> ><?= $category['category_name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="mb-3 flex flex-col">
                                <label for="product-description" class="text-xl font-semibold">Product Description</label>
                                <textarea name="product-description" id="product-description" class="border-2 p-2 rounded-md focus:outline-offset-2 focus:outline-2 focus:outline-blue-500" placeholder="Enter Product Description"><?= $product['product_description']; ?></textarea>
                            </div>
                            <div class="mb-3 flex flex-col">
                                <label for="product-price" class="text-xl font-semibold">Product Price</label>
                                <input type="text" name="product-price" value="<?=  $product['products_price']; ?>" class="border-2 p-2 rounded-md focus:outline-offset-2 focus:outline-2 focus:outline-blue-500" placeholder="Enter Product Price">
                            </div>
                            <div class="mb-3 flex flex-col">
                                <label for="product-stock" class="text-xl font-semibold">Product Stock</label>
                                <input type="text" name="product-stock" value="<?= $product['products_stock']; ?>" class="border-2 p-2 rounded-md focus:outline-offset-2 focus:outline-2 focus:outline-blue-500" placeholder="Enter Product stock">
                            </div>
                            <div class="mb-3 flex flex-col">
                                <label for="product-image">Product Image</label>
                                <input type="file" name="product-image" value="<?= $product['product_image']; ?>" id="product-image" class="border-2 p-2 rounded-md focus:outline-offset-2 focus:outline-2 focus:outline-blue-500 file:bg-gray-500 file:p-1 file:rounded-md file:text-white file:cursor-pointer">
                            </div>
