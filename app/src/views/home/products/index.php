    ...
    <header class="px-16 py-7 bg-white shadow-md">
        <nav class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-10">
                ...
                <img src="/assets/img/male-avatar.svg" class="w-14" alt="">
            </div>
        </nav>
    </header>
    <main>
        <section class="px-16 py-8 grid grid-cols-5 gap-5 place-content-center">
            <?php foreach($products as $product) : ?>
                <!-- Card -->
                <div class="shadow-md rounded-md flex flex-col justify-between">
                    <!-- Card Header -->
                     <div class="w-full">
                        <img class="h-96 object-cover" src="<?= $product['product_image'] ?>" alt="">
                     </div>
                     <!-- Card Body -->
                      <div class="p-3">
